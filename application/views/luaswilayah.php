            ...
            <section class="wrapper">
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active ">
                        <h2 style="text-align:center">INDONESIA JAYA DENGAN LAUT BERDAULAT</h2>
                    ...
                    <div id="menu1" class="tab-pane fade">
                        <div class="col-md-12" id="">
                            <h3 style="text-align:center">PEMBARUAN DATA KEWILAYAHAN INDONESIA</h3></div>
                        <br>
                        ...
                        <div class="row" id="">
                            <div class="col-md-8" id="">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <i class="fa fa-flag"></i>Luas Negara Kesatuan Republik Indonesia
                                    </header>
					...
					<div style="font-size: 10px;">Berdasarkan angka rujukan oleh Badan Informasi Geospasial (BIG) dan Pusat Hidrografi dan Oseanorafi (Pushidros) TNI AL</div>
                                    </div>
                                </section>
                            ...
                            <div class="col-md-4" id="">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <i class="fa fa-flag"></i>Batas Negara Kesatuan Republik Indonesia
                                    </header>
                                    <div class="panel-body">
                                       <p>
...
<div class="row" id=""><div class="col-md-4" id="">
                ...
                <div class="row col-md-12" id="">
                    <ul class="nav nav-tabs nav-justified" style="position:floated; bottom:0;">
                        ...
                        <li style="background-color:white"><a data-toggle="tab" href="#menu2"><img class="img-responsive" src="<?php echo base_url('img/circle-red.png') ?>" alt="" border="0" width="20" height="" style="margin: 0 auto;" /><br>Perubahan Peta NKRI Terkait Batas Laut</a></li>
