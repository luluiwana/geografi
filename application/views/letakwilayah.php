            ...
            <section class="wrapper">
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active ">
                        <h2 style="text-align:center">LETAK ASTRONOMIS INDONESIA</h2>
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="panel">
                                    <header class="panel-heading">
                                        <i class="fa fa-globe"></i>Peta Pembagian Waktu Indonesia
                                    </header>
                        ...
                        <div class="row col-md-12" id="">
                            <div class="col-md-3">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <i class="fa fa-info-circle"></i> Letak Astronomis
                                    </header>
                                    <div class="panel-body">
                                        <table class="table">
                                            <tr>
                                                <td><i class="fa fa-globe"></i></td>
                                                <td>6&#176;LU - 11&#176;LS dan 95&#176;BT - 141&#176;BT</td>
                                            </tr>
                                            <tr>
                                                <td><i class="fa fa-globe"></i></td>
                                                <td>Panjang garis lintang 17&#176; = 1887km</td>
                                            </tr>
                                            <tr>
                                                <td><i class="fa fa-globe"></i></td>
                                                <td>Jarak garis bujur 46&#176; = 5000km</td>
                                            </tr>
                                        </table>
                            ...
                            <div class="col-md-9" id="">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <i class="fa fa-question-circle"></i> Apa Pengaruhnya?
                                    </header>
                                    <div class="panel-body">
                                        <table class="table">
                                            <tr align="left" valign="top">
                                                <td><img src="<?php echo base_url('img/clock-icon.png') ?>" alt="" border="0" width="30" height="" /></td>
                                                <td>Perbedaan Waktu</td>
                                            </tr>
                                            <tr align="left" valign="top">
                    ...
                    <div id="menu1" class="tab-pane fade">
                        <div class="col-md-12" id="">
                            <h3 style="text-align:center">MENGAPA WILAYAH INDONESIA STRATEGIS? </h3></div>
                        <br>
                        ...
                        <div class="row" id="">
                            <div class="col-md-8" id="">
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <img src="<?php echo base_url('img/letak-geografis.jpg') ?>" class="img-responsive img-thumbnail" style="width:100%">
                                    </div>
                                </section>
                                ...
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <table class="table table-hover">
                                            <tr>
                                                <td><i class="fa fa-globe"></i></td>
                                                <td>Berada di Kawasan Asia Tenggara</td>
                                            </tr>
                                            <tr>
                                                <td><i class="fa fa-globe"></i></td>
                                                <td>Letak Geografis, berada di antara Benua Asia dan Benua Australia serta di antara Samudera Hindia dan Samudera Pasifik</td>
                                            </tr>
                                            <tr>
                                                <td><i class="fa fa-globe"></i></td>
                                                <td>Indonesia memiliki 17 ribu pulau dan Panjang pesisir 108.000 km</td>
                                            </tr>
                                        </table>
                                    </div>
                                </section>
                        ...
                        <div class="row col-md-12" id="">
                            <h3 style="text-align:center">DAMPAK SOSIAL-EKONOMI</h3>
                            <br>
                        </div>
                    ...
                    <div id="menu2" class="tab-pane fade">
                        <div class="row" id="" style="text-align:center">
                            <h3>LETAK GEOLOGIS INDONESIA <br/><br/></h3></div>
                        <div class="row" id="">
                            ...
                            <div class="col-md-7" id="">
                                <section class="panel">
                                    ...
                                    <div class="panel-body">
                                        <img src="<?php echo base_url('img/letak-geologis.jpg') ?>" class="img-responsive img-thumbnail" style="width:100%">
                                    </div>
                                </section>
